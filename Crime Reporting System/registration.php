...
<?php
if(isset($_POST['s'])){
    $con=mysqli_connect('sql205.epizy.com','epiz_34022729','PGI71ItO5cOQ','epiz_34022729_crime_portal');
    if(!$con)
    {
		 ...
		 <div class="bg-agile">
            ...
            <h2 class="text-center">Registration</h2>	
				<form action="#" method="post">
                    ...
                    <p style="color:#dfdfdf">Password</p><input type="password"  name="password"  pattern=".{6,}" id="pass" onfocusout="f1()"/>
					<p style="color:#dfdfdf">City</p><input type="text"  name="adress"  required="" id="addr" onfocusout="f1()"/>
