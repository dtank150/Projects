...
<body style="color: black;background-image: url(locker.png);background-size: 100%;background-repeat: no-repeat;back">
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    ...
    <input type="text" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" size="5" placeholder="Enter incharge id" required onfocusout="f1()">
     </div>
  <div class="form-group" style="width:30%">
